!===========================================================================
!Name        :module_caminante_normal.f90
!Description :
!Version     : Beta1.0
!Date        : agosto 03, 2020
...
!===========================================================================
CONTAINS
!===================Inicializacón de variables necesarias===================
SUBROUTINE initialization
  ...
  ELSE
      alp(1:tf)=flag_alpha
  END IF
  satura=((n-1.0)*(7.0*n-3.0))/(24.0*n)+200
  satura=LOG10(satura)
...
!===========================================================================
SUBROUTINE S_GRAU(TM,S)
!==========================================================================#
!Subrutina creada para generar la inversa de la matriz S.
!
!TM(IN)    :Matriz con la trasformada de MELLI.
!S(OUT)    :Matriz diagonal e inversa de S.
!==========================================================================#
!==========================================================================#
  IMPLICIT NONE
  ...
  IF(ALLOCATESTATUS .NE. 0 )STOP "*** NOT ENOUGH MEMORY ***"
  RETURN
END SUBROUTINE S_GRAU
!==========================================================================#
!==========================================================================#
SUBROUTINE MELLI(A,MC,dmax,ALPHA,t,TM)
!SUBRUTINA MELLI APLICA LA TRASNFORMACION DE MELLI QUE REPRESENTA LAS
!INTERACCIONES A VECINOS NO ADJACENTES.
!
!N(IN)       :Dimencion de las matrices de vizinhanza usadas.
!MC(IN)      :Matrz de vizinhanza de red ciclica.
!A(IN)       :Matriz de adjacencia de la red circular con diemnsion N.
!alpha(IN)   :Vector de dimension (1:itx) que contiene los pesos que definen
!             la forma de interaccion de los vecinos no adjacentes.
!TM(OUT)     :Matriz siemtrica que representa las interacciones de vecinos
!             adjacentes como no adjacentes. Osea, la matriz con la trasformada
!             de MELLI.
!==========================================================================#
  IMPLICIT NONE
...
!===============================================================================================================
SUBROUTINE DERIVADA(A,B)
!sUBROUTINA QUE ENTUENTRA LA DERIVAD NUMERICA DE UN VECTOR A,
!Y LOS GUARDA EN B. n, es la dimension de los vectores.
!=======================================================================================
  IMPLICIT NONE
...
!=======================================================================================
!==========================================================================#
!Definicion de la funcion de Heaviside o funcion paso.
!==========================================================================#
SUBROUTINE HEVI(x,y)
  IMPLICIT NONE
...
!=======================================================================================
!=======================================================================================#
!subrutina LINE junto con distancia, encuentran la distancia mas corta
!para vertices en un toru.
...
END MODULE module_caminante_normal
